                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">IMAGE NAME</th>
                                            ...
                                            <tbody>
                                                @foreach($galleryresult as $value)
                                                <tr class="even">
                                                    <td class="dtr-control sorting_1" tabindex="0">{{$value->id}}</td>
                                                    <td>{{$value->imgname}}</td>
                                                    <td><img src="/galleryimg/{{$value->image}}" alt="gallery image"  width="150px" height="150px"></td>
                                                    <td>{{$value->descr}}</td>
                                                    <td><a href="/viewgalleryedit/{{$value->id}}">Edit</a></td>
                                                    <td><a href="/gallerydel/{{$value->id}}">Delete</a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
