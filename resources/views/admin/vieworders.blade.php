                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                            ...
                                            <tbody>
                                                @foreach($vieworders as $value)
                                                <tr class="even">
                                                    <td class="dtr-control sorting_1" tabindex="0">{{$value->id}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="1">{{$value->regname}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="0">{{$value->productname}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="1">{{$value->regemail}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="1">{{$value->regphone}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="2">{{$value->status}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="0">{{$value->price}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="3">{{$value->quantity}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="4">{{$value->totalamount}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
