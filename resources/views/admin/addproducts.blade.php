                        ...
                        <form action="/addproductaction" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="productname" id="exampleInputpname1" placeholder="Enter product name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="pricekg" id="exampleInputpriceKg1" placeholder="enter price">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputimg2">Image</label>
                                    <input type="file" class="form-control"  name="productimage" id="exampleInputimg2" placeholder="enter image of product">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputtotalstock">Total Stock</label>
                                    <input type="text" class="form-control"  name="totalstock" id="exampleInputtotalstock" placeholder="enter total stock">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputavailablestock">Available Stock</label>
                                    <input type="text" class="form-control"  name="availablestock" id="exampleInputavailablestock" placeholder="enter available stock">
                                </div>
                                <div class="form-group">
